...
<head>
  ...
  <link rel="stylesheet" href="/public/css/politicas_privacidad.css?ver=<?php echo $ver ?>">


  <link rel="canonical" href="https://www.hmvrefrigeracion.com/politicas-de-privacidad/" />
  ...
  <script type="application/ld+json">
    {
      ...
      "image": "https://www.hmvrefrigeracion.com/public/img/hmv-suminstro-reparacion-mantenimiento-aire-acondicionado-frio-industrial-logo.png",
      "telephone": ["34 956 941 542"],
      "address": {
        "@type": "PostalAddress",
        "addressLocality": "C/ Jose Garzon, 24 11100 San Fernando, Cadiz"
      },
      "url": "https://www.hmvrefrigeracion.com/"
    }
  </script>
</head>
<body>
...
<noscript id="tagmanager">
  <iframe
    src="https://www.googletagmanager.com/ns.html?id=GTM-5GDXQMB"
    height="0"
    width="0"
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="container">
      <div class="content">
        <!-- Header - Logo -->
        <div class="container_logo" id="inicio">
          <a href="/" class="container_logo_img">
            <picture>

              <img src="/public/img/hmv-suminstro-reparacion-mantenimiento-aire-acondicionado-frio-industrial-logo.png"
                alt="Mejor empresa en refrigeración en España" title="Mejor empresa en refrigeración en España">
            </picture>
          </a>
          <div class="container_logo_contact">
            <div class="container_header_contact_phone">
              ...
              <p>
              LLÁMANOS: <a href="tel:34956941542" onclick="gtag('event', 'telefonos')"><b>956 94 15 42</b></a> - <a href="tel:34627961291" onclick="gtag('event', 'telefonos')"><b>627 96 12 91</b></a>
              </p>
            </div>
            <div class="container_contact_button">
              ...
              <a href="https://api.whatsapp.com/send?phone=34627961291" target="_blank"
                onclick="gtag('event', 'whatsapp')">Enviar Whatsapp</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container bg_blue">
      <div class="content">
        <div class="container_nav">
          <div class="toggle">
            <svg xmlns="http://www.w3.org/2000/svg" id="openMenu" height="48" width="48"><path d="M6 36v-3h36v3Zm0-10.5v-3h36v3ZM6 15v-3h36v3Z"/></svg>
          </div>
          <nav class="container_nav_enlaces" id="menuMobile">
            <p class="closeMenu" id="closeMenu">X</p>
            <a href="../#aire">AIRE ACONDICIONADO</a>
            <a href="../#frio">FRÍO INDUSTRIAL</a>
            <a href="../#services">SERVICIO 24H</a>
            <a href="../#tecnologia">TECNOLOGÍA Y MATERIAS PRIMAS</a>
          ...
          <div class="container_nav_social">
            ...
            <a href="https://twitter.com/" Target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <a href="https://www.facebook.com/" Target="_blank"><svg class="icon_facebook" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
    ...
    <div class="container">
      <div class="content">
        <section class="politicas_privacidad">
          <div class="politicas_privacidad_title">
          Politicas de Privacidad
          </div>
          <div class="politicas_privacidad_subtitle">
            <p>El PROPIETARIO DE LA WEB es responsable de la recogida de datos personales a los usuarios en este apartado y será el encargado del tratamiento de los mismos.</p>
          ...
          <table border="1">
            <tr>
              ...
              <td>	
                Razón social: MANUEL PEÑA TOLEDO <br>
                NIF/CIF: 75811248M <br>
                Dirección: Calle José Garzón, 24 11100 San Fernando Cádiz <br>
                Correo: hvm_clima@hotmail.com <br>
              </td>
            </tr>
            ...
            <tr>
              <td>Legitimación</td>
              <td>
                Se solicita el consentimiento del interesado para el tratamiento de sus datos y la oferta prospectiva de productos y servicios.
              </td>
            </tr>
          ...
          <div class="politicas_privacidad_content">
            <ol>
              <li>¿Quién es el responsable del tratamiento de tus datos personales?</li>
              <p>MANUEL PEÑA TOLEDO, NIF/ CIF: 75811248M, dirección: Calle José Garzón, 24 11100 San Fernando Cádiz y correo electrónico hvm_clima@hotmail.com es el RESPONSABLE del tratamiento de los datos personales del USUARIO y le informa de que estos datos serán tratados de conformidad con lo dispuesto en el Reglamento (UE) 2016/679, de 27 de abril (GDPR), y la Ley Orgánica 3/2018, de 5 de diciembre (LOPDGDD).</p>
              
              <li>¿Con qué finalidad se tratan los datos y cuál es la base que legitima el tratamiento?</li>
              <p>Se trata la información que nos facilitan las personas interesadas con el fin de gestionar el envío de la información que nos soliciten, pudiendo elaborarse, de ser necesario, un perfil comercial, en base a la información facilitada. Tramitar encargos, solicitudes, dar respuesta a las consultas o cualquier tipo de petición que sea realizada por el USUARIO a través de cualquiera de las formas de contacto que se ponen a su disposición en la página web del RESPONSABLE.</p>
      
              <li>¿Cuánto tiempo se conservan los datos?</li>
              ...
              <li>¿Qué derechos existen y cómo ejercerlos?</li>
              ...
              <p>Para ejercer sus derechos deberá ponerse en contacto con el Responsable en la dirección Calle José Garzón, 24 11100 San Fernando Cádiz acompañado de copia documento de identidad del interesado.</p>
              ...
              <p>A continuación le indicamos cuales son los derechos que le asisten: <br>
                * Solicitar el ACCESO a sus datos personales.<br>
                * Solicitar la RECTIFICACION de sus datos.<br>
                * Solicitar la SUPRESIÓN o eliminación de sus datos (derecho al "olvido").<br>
                * LIMITAR u OPONERSE al uso que le damos a sus datos.<br>
                * Derecho a la PORTABILIDAD de sus datos para casos de servicios de telecomunicaciones o internet.<br>
                * Derecho a RETIRAR su consentimiento en cualquier momento.<br>
                * Tendrá derecho a presentar una reclamación ante la Agencia Española de Protección de Datos a través de www.aepd.es.<br>
                </p>
                <p>Para el ejercicio de sus derechos de acceso, rectificación, supresión, limitación u oposición, portabilidad y retirada de su consentimiento, deberá ponerse en contacto con el Responsable en la dirección Calle José Garzón, 24 11100 San Fernando Cádiz .</p>

              <li>¿A quién facilitamos tus datos personales? Destinatarios</li>
              <p>Los datos personales no se cederán a terceros, salvo en su caso, otras empresas de grupo para fines administrativos internos o salvo obligación legal.</p>
      
              <li>¿Se toman decisiones automatizadas?</li>
              <p>No se tomarán decisiones automatizadas en base al perfil comercial.</p>
      
              <li>¿Se realizan transferencias internacionales de datos?</li>
              <p>No realizamos transferencias internacionales de sus datos</p>
      
              <li>Aviso legal</li>
              <p>Todos los textos, fotografías, logotipos, cupones, productos, servicios e imágenes visualizadas, así como, en su caso, los mensajes de voz, son recogidos bajo la responsabilidad única y exclusiva del PROPIETARIO DE LA WEB, quien es responsable de la veracidad de la información contenida en la página web.</p>
              <p>Existen hojas de reclamaciones a disposición del consumidor en la dirección de MANUEL PEÑA TOLEDO, NIF/ CIF: 75811248M: Calle José Garzón, 24 11100 San Fernando (Cádiz), pudiendo ponerse en contacto en cualquier momento en la dirección de correo electrónico hvm_clima@hotmail.com</p>
              ...
              <a href="https://ec.europa.eu/consumers/odr/main/index.cfm?event=main.home2.show&lng=ES">https://ec.europa.eu/consumers/odr/main/index.cfm?event=main.home2.show&lng=ES</a>
