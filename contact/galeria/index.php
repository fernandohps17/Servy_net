...
<head>
  ...
  <link rel="stylesheet" href="../public/css/galeria.css?ver=<?php echo $ver ?>">

  <link rel="canonical" href="https://www.hmvrefrigeracion.es/galeria/">
...
<body>
      ...
      <div class="content">
        ...
        <div class="container_logo" id="home">
          <a href="/" class="container_logo_img">
            <picture>
              <img src="../public/img/hmv-suminstro-reparacion-mantenimiento-aire-acondicionado-frio-industrial-logo.png" alt="Mejor empresa en refrigeración en España" title="Mejor empresa en refrigeración en España">
            </picture>
          </a>
          <div class="container_logo_contact">
            ...
            <div class="container_contact_button">
              ...
              <a href="https://api.whatsapp.com/send?phone=34627961291" target="_blank" onclick="gtag('event', 'whatsapp')">Enviar Whatsapp</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="content">
            <div class="bigBox" id="bigBox">
              <img src="/public/img/hmv-suminstro-reparacion-mantenimiento-aire-acondicionado-frio-industrial-galeria-01.webp" id="bigImg" alt="Servicio de refigeración en España" title="El mejor servicio de regigeración en España">
              <span onclick="closeImg()">X</span>
            </div>

            <div class="section_galeria">
              <div class="section_galeria_title">
                <h2>Galería</h2>
              </div>
              <div class="section_galeria_image">
                <?php require_once('../galery.php') ?>
              </div>
            </div>
          </div>
        </div>
  ...
  <script src="/public/js/map.js?ver=<?php echo $ver ?>"></script>
  <script src="/public/js/header_slider.js?ver=<?php echo $ver ?>"></script>
  <script src="/public/js/carga_diferida.js?ver=<?php echo $ver ?>"></script>
  <script src="/public/js/recatpcha.js?ver=<?php echo $ver ?>"></script>
  <script src="/public/js/gallery.js?ver=<?php echo $ver ?>"></script>
</body>
</html>